            ...
            request.perform { (jsonResponse, httpResponse, _) in
                ...
                do {
                    if jsonResponse != nil {
                        ...
                        propertyListResponse = try JSONSerialization.jsonObject(with: jsonResponse!, options: JSONSerialization.ReadingOptions.mutableLeaves)
                ...
                self.synchronize {
                    self.captureFollowonRequestInfo(propertyListResponse as TwitterRequest.PropertyList?)
                }
                handler(propertyListResponse as TwitterRequest.PropertyList?)
            }
        } else {
